...
\vspace{.25cm}
 ...
 \centerline{Rui Wang, Xingzhong Xu}
\vspace{.4cm}
...
for $i\in \mathcal{C}_2$,
    ...
    \begin{equation*}
        \begin{split}
        &\lambda_i^2(\bY^\top \bY-\widehat{\mytr(\bLambda_2)}\bI_n)
        \\
        \leq
        &
        \max
...
\bZ^{\dagger \top} \bLambda^{1/2}\bU^\top (\bI_p-\bP_{\bY})\bU\bLambda^{1/2}\bZ^{\dagger}+
 ...
 \right.
 \\
 &\quad \quad \quad \quad \,\, \left.-\left(\mytr(\bSigma)-{n\mytr(\bSigma^2)}/{\mytr(\bSigma)}\right)
 \right)
 \\
    =&
    \lambda_1\left(
