...
Within the $i$th sample ($1\leq i\leq k$), the observations $\{X_{ij}\}_{j=1}^{n_i}$ are independent and identically distributed (i.i.d.) as $N_p(\xi_i,\bSigma)$, the $p$ dimensional normal distribution with mean vector $\xi_i$ and common variance matrix $\bSigma$.
...
To overcome this,
suppose $\sqrt{n_i} \xi_i$ has prior distribution $N_p(0,\psi \bI_p)$, $i=1,2$.
In this case,
$
