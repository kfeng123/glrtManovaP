...
In practice, one may not know if the covariance matrix is spiked. Even if it is known that the covariance matrix is spiked, the spike number $r$ may be unknown.
Now we consider the detection of spiked covariance and the estimation of $r$.
