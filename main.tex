...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
By assumption, we have $r\blambda_{r+1}=o(\mytr(\bLambda_2))$ and
            $\sqrt{r\mytr\left(\bLambda_2^2\right)}
            \leq
            \sqrt{r\blambda_{r+1}\mytr\left(\bLambda_2\right)}
            =o(\mytr(\bLambda_2))
            $.
            Hence $
        \lambda_1\left( \bL \bLambda_2 \bL^T \right) 
...
It follows that
    \begin{equation*}
        \begin{split}
                ...
                O_P
                \left(
                    \sqrt{\frac{\mytr(\bLambda_2)}{n\blambda_r}}\sqrt{\frac{r}{n}}
    \right)
    \\
    =&
                O_P
                \left(
                    \frac{\mytr(\bLambda_2)}{n\blambda_r}+\frac{r}{n}
    \right)
    ,
        \end{split}
    \end{equation*}
    where the second last equality follows from \eqref{firstTermNao} and
...
\begin{proposition}
    A proposition for small eigenvalues
...
\right)
        ...
        \end{split}
    \end{equation*}
    where the second last equality follows from~\eqref{conB2B1},~\eqref{firstTermNao} and~\eqref{ineqForZ2}.
    Thus,
    \begin{equation*}
        \begin{split}
             &(\bP^*_{\bY,1}-\bU_{\bY,1}\bU_{\bY,1}^T)\hat{\bSigma}(\bI_p-\bP^*_{\bY,1})
