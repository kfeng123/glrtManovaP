...
\section{Introduction}
   In high dimensional setting, it is known that the likelihood ratio test, which has a dominated position in classical multivariate analysis, is not well defined for many testing problems.
