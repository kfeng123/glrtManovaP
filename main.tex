...
\end{equation*}
It is not hard to show that $\widehat{\mytr(\bSigma)}=\mytr(\bSigma)+O_P(\sqrt{n^{-1}\mytr(\bSigma^2)})$ and
$
\widehat{\mytr(\bSigma^2)}=\mytr(\bSigma^2)+O_P(n^{-1}\mytr(\bSigma^2)+n^{-1/2} \mytr^{1/2}(\bSigma^4)).
$
