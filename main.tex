...
%Suppose there are $k$ normal populations with possibly different means $\mu_1,\ldots,\mu_k$, but all with the same variance $\Sigma$.
...
However, when $p\geq n$, the four classical test statistics can not be defined.
 ...
 So far, most tests in the literature are designed for two sample case, i.e. $k=2$.
  See, for example,~\citet{Bai1996Efiect,Chen2010A,Srivastava2009A,Feng2015Multivariate,Tony2013}.
...
$$
The likelihood ratio test statistic for $H_a$ against $K_a$% (which is also the uniformly most powerful unbiased test) 
is
%Note that
%\begin{equation*}
    %\begin{aligned}
