...
\begin{lemma}[Lemma of Fan]
    ...
    \end{equation*}
        ...
        \begin{equation}
            ...
            \\
            \leq&
            24\epsilon \|f((\hat{\bA}-\bA)\bU_{\bA,1})\|_F.
            \end{split}
        \end{equation}
\end{lemma}
...
-\mytr(\bLambda_2) \bI_{p-r} \right\|.
    ...
    \begin{equation*}
        \begin{split}
        n^{-1} \left\|\bLambda_1^{1/2} \bZ_A \bZ_B^T \bLambda_2^{1/2}\right\|
        = n^{-1} \left\|\bLambda_1^{1/2} (\bZ_A \bZ_A^T)^{1/2} \bL \bLambda_2^{1/2}\right\|,
        \end{split}
    \end{equation*}
...
\begin{equation*}
    \begin{split}
        &
n^{-1} \left\|\bLambda_1^{1/2} \bZ_A \bZ_B^T \bLambda_2^{1/2}\right\|
        = n^{-1} \lambda_1\left(\bLambda_1^{1/2} (\bZ_A \bZ_A^T)^{1/2} \bL \bLambda_2 \bL^T (\bZ_A \bZ_A^T)^{1/2} \bLambda_1^{1/2}\right)^{1/2}
        \\
        \leq &
        n^{-1} \blambda_1^{1/2} \lambda_1\left(  \bZ_A \bZ_A^T \right)^{1/2}
...
\begin{equation*}
n^{-1} \left\|\bLambda_1^{1/2} \bZ_A \bZ_B^T \bLambda_2^{1/2}\right\|
=O_P(1)\sqrt{\frac{\blambda_1 \left( \mytr(\bLambda_2)
            +\sqrt{r\mytr\left(\bLambda_2^2\right)}
            +r\blambda_{r+1}
\right)}{n}}.
\end{equation*}
...
-
            ...
            \\
            \leq &
            24 \frac{\|\hat{\bSigma}-\hat{\bSigma}_0\|}{\blambda_r-\blambda_{r+1}} \|f((\hat{\bSigma}-\hat{\bSigma}_0)\bU_1)\|_F.
        \end{split}
    \end{equation*}
