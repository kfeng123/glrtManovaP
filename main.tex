...
This paper considers the problem of multivariate analysis of variance for normal samples.
    ...
    Our theoretical results and simulations show that the proposed test has particular high power when there are strong correlations between variables.
...
%The likelihood ratio test (LRT) has a dominated position in classical multivariate analysis.
   Note that both sum-of-squares type statistics and extreme value type statistics are not based on likelihood function.
    ...
    They found that the unboundedness of likelihood function contains useful information.
...
While the asymptotic powers of most existing tests are negatively affected by the large eigenvalues of the covariance matrix, the asymptotic power of the new test doesn't depend on the large eigenvalues of the covariance matrix. 
...
is an increasing function of $T_a$.
...
Hence the component LRT statistic characterizes the discrepancy between  $H_{0a}$ and $H_{1a}$.
...
Roy's maximum root can only be defined when $n-k\geq p$, hence can not be used in the high dimensional setting.
...
$$
\textrm{SNR}=\frac{\|\Xi\bC\|_F^2}{\sqrt{\bLambda_2^2}}.
$$
...
%$$
%SNR=\frac{\|\Xi \bC\|_F^2}{\sqrt{\mytr (\bSigma^2)}}
%$$
...
\begin{table}[!hbp]
    ...
    \midrule
0 & 0.030 & 0.060 & 0.020 & 0.050 & 0.030 & 0.030 & 0.050 & 0.080 & 0.090 \\ 
1 & 0.070 & 0.070 & 0.100 & 0.020 & 0.060 & 0.090 & 0.050 & 0.030 & 0.090 \\ 
2 & 0.080 & 0.040 & 0.150 & 0.190 & 0.060 & 0.140 & 0.060 & 0.030 & 0.100 \\ 
3 & 0.070 & 0.070 & 0.230 & 0.020 & 0.020 & 0.110 & 0.100 & 0.070 & 0.220 \\ 
4 & 0.140 & 0.060 & 0.250 & 0.080 & 0.060 & 0.330 & 0.130 & 0.030 & 0.310 \\ 
5 & 0.240 & 0.060 & 0.410 & 0.090 & 0.040 & 0.490 & 0.090 & 0.110 & 0.460 \\ 
6 & 0.280 & 0.100 & 0.510 & 0.150 & 0.080 & 0.530 & 0.210 & 0.090 & 0.650 \\ 
7 & 0.240 & 0.110 & 0.590 & 0.230 & 0.070 & 0.720 & 0.190 & 0.020 & 0.740 \\ 
8 & 0.340 & 0.060 & 0.670 & 0.280 & 0.090 & 0.770 & 0.260 & 0.110 & 0.810 \\ 
9 & 0.320 & 0.070 & 0.790 & 0.250 & 0.010 & 0.820 & 0.190 & 0.070 & 0.870 \\ 
10 & 0.310 & 0.130 & 0.780 & 0.310 & 0.130 & 0.950 & 0.370 & 0.040 & 0.930 \\ 
\bottomrule
\end{tabular}
\end{table}
...
\multirow{2}{*}{SNR} &\multicolumn{3}{c}{$p=100$}&\multicolumn{3}{c}{$p=150$}&\multicolumn{3}{c}{$p=200$} \\
    \cmidrule(r){2-4}\cmidrule(r){5-7}\cmidrule(r){8-10}
        & CX & SC & NEW & CX &SC &NEW &CX & SC & NEW\\
\midrule
0 & 0.070 & 0.070 & 0.020 & 0.030 & 0.090 & 0.090 & 0.040 & 0.050 & 0.040 \\ 
1 & 0.060 & 0.040 & 0.060 & 0.090 & 0.100 & 0.120 & 0.030 & 0.030 & 0.070 \\ 
2 & 0.080 & 0.080 & 0.190 & 0.070 & 0.020 & 0.170 & 0.160 & 0.040 & 0.240 \\ 
3 & 0.130 & 0.070 & 0.160 & 0.100 & 0.050 & 0.240 & 0.130 & 0.060 & 0.310 \\ 
4 & 0.130 & 0.050 & 0.240 & 0.160 & 0.040 & 0.250 & 0.100 & 0.050 & 0.410 \\ 
5 & 0.120 & 0.070 & 0.330 & 0.090 & 0.080 & 0.450 & 0.100 & 0.060 & 0.590 \\ 
6 & 0.170 & 0.080 & 0.540 & 0.190 & 0.030 & 0.680 & 0.120 & 0.040 & 0.740 \\ 
7 & 0.170 & 0.020 & 0.460 & 0.230 & 0.070 & 0.800 & 0.160 & 0.030 & 0.810 \\ 
8 & 0.310 & 0.100 & 0.610 & 0.220 & 0.040 & 0.780 & 0.190 & 0.050 & 0.910 \\ 
9 & 0.320 & 0.090 & 0.650 & 0.190 & 0.100 & 0.870 & 0.150 & 0.020 & 0.950 \\ 
10 & 0.340 & 0.060 & 0.710 & 0.210 & 0.080 & 0.940 & 0.220 & 0.110 & 0.950 \\ 
\bottomrule
\end{tabular}
\end{table}
...
\multirow{2}{*}{SNR} &\multicolumn{3}{c}{$p=50$}&\multicolumn{3}{c}{$p=75$}&\multicolumn{3}{c}{$p=100$} \\
    \cmidrule(r){2-4}\cmidrule(r){5-7}\cmidrule(r){8-10}
        & CX & SC & NEW & CX &SC &NEW &CX & SC & NEW\\
\midrule
0 & 0.050 & 0.040 & 0.050 & 0.040 & 0.010 & 0.050 & 0.080 & 0.020 & 0.050 \\ 
1 & 0.080 & 0.060 & 0.050 & 0.070 & 0.040 & 0.060 & 0.090 & 0.010 & 0.070 \\ 
2 & 0.140 & 0.090 & 0.180 & 0.060 & 0.030 & 0.160 & 0.090 & 0.030 & 0.060 \\ 
3 & 0.080 & 0.060 & 0.160 & 0.090 & 0.070 & 0.180 & 0.150 & 0.060 & 0.180 \\ 
4 & 0.220 & 0.070 & 0.180 & 0.180 & 0.040 & 0.310 & 0.170 & 0.090 & 0.290 \\ 
5 & 0.300 & 0.070 & 0.350 & 0.250 & 0.040 & 0.420 & 0.200 & 0.040 & 0.270 \\ 
6 & 0.290 & 0.120 & 0.390 & 0.210 & 0.060 & 0.390 & 0.270 & 0.060 & 0.440 \\ 
7 & 0.370 & 0.160 & 0.500 & 0.190 & 0.050 & 0.450 & 0.210 & 0.110 & 0.540 \\ 
8 & 0.410 & 0.030 & 0.590 & 0.440 & 0.090 & 0.700 & 0.360 & 0.060 & 0.640 \\ 
9 & 0.470 & 0.120 & 0.630 & 0.310 & 0.070 & 0.750 & 0.290 & 0.080 & 0.720 \\ 
10 & 0.430 & 0.050 & 0.610 & 0.500 & 0.090 & 0.730 & 0.480 & 0.090 & 0.740 \\ 
\bottomrule
\end{tabular}
\end{table}
...
\multirow{2}{*}{SNR} &\multicolumn{3}{c}{$p=100$}&\multicolumn{3}{c}{$p=150$}&\multicolumn{3}{c}{$p=200$} \\
    \cmidrule(r){2-4}\cmidrule(r){5-7}\cmidrule(r){8-10}
        & CX & SC & NEW & CX &SC &NEW &CX & SC & NEW\\
\midrule
0 & 0.070 & 0.040 & 0.050 & 0.070 & 0.030 & 0.070 & 0.010 & 0.030 & 0.010 \\ 
1 & 0.080 & 0.020 & 0.040 & 0.080 & 0.040 & 0.100 & 0.070 & 0.020 & 0.110 \\ 
2 & 0.090 & 0.080 & 0.170 & 0.170 & 0.130 & 0.130 & 0.130 & 0.090 & 0.130 \\ 
3 & 0.160 & 0.050 & 0.210 & 0.130 & 0.030 & 0.270 & 0.090 & 0.010 & 0.280 \\ 
4 & 0.170 & 0.020 & 0.260 & 0.140 & 0.050 & 0.320 & 0.070 & 0.050 & 0.300 \\ 
5 & 0.200 & 0.070 & 0.290 & 0.200 & 0.060 & 0.360 & 0.180 & 0.040 & 0.420 \\ 
6 & 0.210 & 0.090 & 0.360 & 0.130 & 0.060 & 0.550 & 0.180 & 0.040 & 0.650 \\ 
7 & 0.250 & 0.060 & 0.290 & 0.280 & 0.060 & 0.600 & 0.210 & 0.030 & 0.670 \\ 
8 & 0.350 & 0.040 & 0.490 & 0.370 & 0.050 & 0.720 & 0.260 & 0.090 & 0.730 \\ 
9 & 0.390 & 0.080 & 0.550 & 0.430 & 0.070 & 0.780 & 0.390 & 0.040 & 0.820 \\ 
10 & 0.460 & 0.080 & 0.600 & 0.410 & 0.070 & 0.800 & 0.380 & 0.090 & 0.870 \\ 
\bottomrule
\end{tabular}
\end{table}
...
We write
$
\bX\bJ\bC = \Xi \bC + \bU\bLambda^{1/2} \bG_2
$, 
...
\Xi \bC^T (\bI_p -\bP_{\bY})\Xi \bC+\\
&\Xi \bC^T (\bI_p -\bP_{\bY})\bU\bLambda^{1/2}\bG_2+
\bG_2^T \bLambda^{1/2}\bU^T (\bI_p-\bP_{\bY})\Xi \bC.
\end{aligned}
\end{equation}
