...
$$
        ...
        &Y_i^T \bU_2 \bU_2^T (\bU_{\bY,2;(i,j)} \bU_{\bY,2;(i,j)}^T-\bU_2\bU_2^T) \bU_2 \bU_2^T Y_j\\
        =&O_P(1)\sqrt{p}
            \lambda_1(\Lambda_2^{1/2}\bU_2^T (\bU_{\bY,2;(i,j)} \bU_{\bY,2;(i,j)}^T-\bU_2\bU_2^T) \bU_2 \Lambda_2^{1/2})\\
        =&O_P(1)\sqrt{p}
    ...
    \begin{aligned}
        &Y_i^T \bU_1 \bU_1^T \bU_{\bY,2;(i,j)} \bU_{\bY,2;(i,j)}^T \bU_2 \bU_2^T Y_j\\
        =&
        O_P(1)\sqrt{r}\|\Lambda_1^{1/2}\bU_1^T \bU_{\bY,2;(i,j)}\bU_{\bY,2;(i,j)}^T \bU_2 \Lambda_2^{1/2}\|\\
        =&
...
&Y_i^T \bU_1 \bU_1^T \bU_{\bY,2;(i,j)} \bU_{\bY,2;(i,j)}^T \bU_1 \bU_1^T Y_j\\
=
    &O_P(1)\sqrt{r}\|\Lambda_1^{1/2}\bU_1^T \bU_{\bY,2;(i,j)}\bU_{\bY,2;(i,j)}^T \bU_1 \Lambda_1^{1/2}\|\\
    =
    &O_P(1)\sqrt{r}\lambda_1\|\bU_1^T \bU_{\bY,2;(i,j)}\bU_{\bY,2;(i,j)}^T \bU_1\|\\
    =
    &O_P(1)\sqrt{r}\lambda_1 \frac{p}{\lambda_r n}
\end{aligned}
$$

    Hence $w_{ij}=Y_i^T \bU_2 \bU_2^T Y_j+o_P(\sqrt{p})$

    Hence $w_{ij}=(Y_i^T \bU_2 \bU_2^T Y_j)^2+o_P(p)$
