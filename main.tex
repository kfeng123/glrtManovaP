...
This paper considers the problem of multivariate analysis of variance for normal samples.
    ...
    The asymptotic distributions of the test statistic are derived under both nonspiked and spiked covariance.
...
In fact, \cite{WANG2018225} requires $p/n^2\to 0$, while under the factor model in \cite{Ma2015A}, \cite{Aoshima2018} requires $p/n \to 0$.
   ...
   In high dimensional setting, both sum-of-squares type statistics and extreme value type statistics are not based on likelihood function.
    ...
    We gives the asymptotic distributions of the test statistic under both nonspiked covariance and spiked covariance.
    An adaptive LFD test procedure is constructed by consistently estimating unknown parameters and detect unknown covariance structure.
    ...
    The asymptotic distributions of the LFD test statistic under both nonspiked covariance and spiked covariance are given in Section \ref{THEO}.
...
We shall give theoretical results under both nonspiked covariance and spiked covariance.
...
Now we derive the theoretical results under the spiked covariance, which are much more involved than the nonspiked case.
...
To intuitively understand this phenomenon,  we note that % in \ref{statisticForm1} 
for $k=2$, 
...
\begin{table}[!hbp]
    \caption{Empirical powers of tests. $\alpha=0.05$, $n_1=n_2=n_3=20$, $p=300$. }
    \label{table1}
    \centering
    \begin{tabular}{*{11}{l}}
    \toprule
...
& Sc & CX & HBWW & ZGZ & NEW & Sc & CX & HBWW & ZGZ & NEW \\ 
    \midrule
...
\end{table}
\begin{table}[!hbp]
    \caption{Empirical powers of tests. $\alpha=0.05$, $n_1=n_2=n_3=40$, $p=800$. }
    \label{table3}
    \centering
    \begin{tabular}{*{11}{l}}
    \toprule
...
We derived the asymptotic distribution of the LFD test statistic under both nonspiked covariance and spiked covariance.
We also gave the asymptotic local power function.
