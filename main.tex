...
{\color{red}
The case $k=2$ and the least favorable direction.
}
...
Hence we use permutation method to determine the critical values during our simulations.
...
We shall denote these tests by SR, CQ, CLX and FZWZ, respectively.
